...
//Define paths
var paths = {
  scripts: ['src/site_js/site/util.js', 'src/site_js/site/main.js', 'src/site_js/site/*.js'],
  vendor_head_scripts: ['src/site_js/vendor/head/*.js'],
  vendor_foot_scripts: ['src/site_js/vendor/foot/console.js','src/site_js/vendor/foot/*.js'],
  sass: ['src/site_sass/**/*.scss'],
  html: ['src/__site_html/*.html', 'src/templates/**/*.html'],
  images: ['public/assets/site_images/**/*']
};
...
gulp.task('images', function() {
  return gulp.src(paths.images)
    ...
    .pipe(gulp.dest('public/assets/site_images/'))
    .pipe(livereload());
});
